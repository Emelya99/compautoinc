<template>
    ...
    >
        <span class="img-container">
            <img 
                :src="platform.image_background ? platform.image_background : require('@/assets/images/placeholder-game.jpg')" 
                :alt="`${platform.name} background image`" 
                loading="lazy"
            >
        </span>
...
.platform-billet.card1 {
    ...
    .img-container {
        ...
        &::after {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(180deg, rgba(23, 23, 23, 0.30) 0%, rgba(23, 23, 23, 0.90) 100%);
        }
    }
