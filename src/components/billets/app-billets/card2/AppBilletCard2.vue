<template>
    ...
    >
        <span class="img-container">
            ...
            <img v-else src="@/assets/images/placeholder-game.png" :alt="product.name" loading="lazy">
        </span>
        <span class="concise-info">
            ...
            <span class="text ellipsis-multiply eight">{{ product.description_raw }}</span>
